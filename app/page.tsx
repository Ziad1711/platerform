import { metadata } from './(marketing)/page'
...
export default function HomePage() {
  return (
    <div className="relative min-h-screen overflow-x-clip bg-jisra-ink text-jisra-cream">
      ...
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:absolute focus:left-4 focus:top-4 focus:z-[100] focus:rounded-md focus:bg-white focus:px-4 focus:py-2"
      >
        Aller au contenu
      </a>
      <MarketingHeader />
