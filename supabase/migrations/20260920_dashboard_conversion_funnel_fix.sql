-- Tunnel de conversion: etapes cumulatives + indicateur "Annulees".
-- Confirmations = confirmees/pickup/expediees/livrees/retournees
-- Expediees = expediees/livrees/retournees (un retour a bien ete expedie)
-- Livrees = statut actuel 'delivered'
-- Retour = retournees (stockees ou non stockees)
-- Annulees = statut actuel 'cancelled'
